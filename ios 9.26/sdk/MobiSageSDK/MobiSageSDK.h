...
// ver : 6.3.0
#define MS_Test_PublishID        @"1NXUB7tAWc7ncfSOUw=="
#define MS_Test_SlotToken_Banner @"jYyNXuIaAJe+KK3XCh5WsAGr"
#define MS_Test_SlotToken_Poster @"+vv6KZVtd+DJX9qgfWkhx3bd"
#define MS_Test_SlotToken_Splash @"6OnoO4d/ZfLbTciyb3sz1WTM"
#define MS_Test_SlotToken_Native @"Dw4P3GCYghU8qi9ViJzUMoMh"
