...
- (void)requestMovieTry
{
    ...
    NSString *url = [NSString stringWithFormat:@"%@/flashinterface/getmoviebypage.ashx?page=%d&pagesize=10&title=%@&topicid=%@",HOST,videopage,self.title,appdelegate.topicId];
...
{
    UrlRequest *request = [[UrlRequest alloc] init];
    NSString *url = [NSString stringWithFormat:@"%@/flashinterface/getpicturesbypage.ashx?page=%d&pagesize=10&title=%@&topicid=%@",HOST,imagepage,self.title,appdelegate.topicId];
...
{
    UrlRequest *request = [[UrlRequest alloc] init];
    NSString *url = [NSString stringWithFormat:@"%@/flashinterface/getnewsbypage.ashx?page=%d&pagesize=10&title=%@&topicid=%@",HOST,newspage,self.title,appdelegate.topicId];
...
{
    UrlRequest *request = [[UrlRequest alloc] init];
    NSString *url = [NSString stringWithFormat:@"%@/flashinterface/getpartbypage.ashx?page=%d&pagesize=10&title=%@&topicid=%@",HOST,partpage,self.title,appdelegate.topicId];
...
- (void)reloadTableView
{
    ...
    [MobClick event:[NSString stringWithFormat:@"正在查看搜索结果%@",type]];
